...
func TestSimple(t *testing.T) {
	lru := lru.New[string, struct{}](lru.WithCapacity(5))

	lru.Set("test", struct{}{})
	lru.Set("test1", struct{}{})
	lru.Set("test2", struct{}{})
	lru.Set("test1", struct{}{})
	lru.Set("test3", struct{}{})
	lru.Set("test4", struct{}{})
	lru.Set("test5", struct{}{})
	lru.Set("test6", struct{}{})

	require.Equal(t, lru.Keys(), []string{"test6", "test5", "test4", "test3", "test1"})
}
